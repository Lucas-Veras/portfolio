...
//       <div className="absolute top-0 -right-3 -z-10 h-[103%] w-[101%] rounded-[2rem] rounded-br-3xl bg-dark xs:-right-2 xs:h-[102%] xs:w-[100%] xs:rounded-[1.5rem]" />
//       <Link
//         href={link}
//         target="_blank"
...
const Articles = () => {
  return (
    <>
      <Head>
        <title>Lucas Oliveira Véras - Artigos</title>
        <meta name="description" content="Lucas Oliveira Véras - Artigos" />
      </Head>
      <TransitionEffect />
      <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light">
        <Layout className="pt-16">
          <AnimatedText
            text={" Em breve..."}
            className="mt-[22vh] mb-[22vh] !text-5xl lg:!text-5xl sm:mb-8 sm:!text-4xl xs:text-3xl"
          />
